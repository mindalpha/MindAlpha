...
public:
    ...
    void ClearSlicesAndDataTypes() { ClearSlices(); message_meta_.ClearSliceDataTypes(); }
    ...
    template<typename T>
    void AddTypedSlice(SmartArray<T> slice)
    {
    ...
    template<typename T>
    SmartArray<T> GetTypedSlice(size_t i) const
    {
